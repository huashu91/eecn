...
if(name != null && time != null) {
	Event ev = new Event();
	ev.insertEvent(name, host, time, other);
...
<div class="form-group">
	<input type="text" placeholder="赛事名称" class="form-control" name="name">
</div>
<div class="form-group">
	<input type="text" placeholder="主办方" class="form-control" name="host">
</div>
<div class="form-group">
	<input type="text" placeholder="进行时间:例如2015-8-10至2015-9-10" class="form-control" name="time">
</div>
<div class="form-group">
